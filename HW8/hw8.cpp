...
else{cout << "Magician bookings full" << endl;}
...
else{list1.addRear( custname, holidayname );
...
else{check = searchId(magname, holidays, holidaySize);
...
else{cout << "No magician or holiday with the name " << magname << " found." << endl;}
...
// move customer to wait list if schedule full// update transactions.txt
...
}else{cout << magname << " not found." << endl;}
